...
def read(adc = None, calibrationAir = None, calibrationWater = None, attenuation = ADC.ATTN_11DB, resolution = ADC.WIDTH_12BIT, cycle=5):
    """
    ...
    # map the value
    sm = ((calibrationAir - raw) / (calibrationAir - calibrationWater)) * 100
    sm = max(0, min(100, sm))
